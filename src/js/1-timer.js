...
// function startTimer() {
//   const userSelectedDate = flatpickr.parseDate(datetimePicker.value);
...
//   countdownInterval = setInterval(() => updateTimer(userSelectedDate), 1000);
// }
...
//     iziToast.success({
//       title: "Time's up!",
//       message: 'Countdown timer has reached zero.',
//     });
//   } else {
